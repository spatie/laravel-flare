...
It is possible to search for certain errors in Flare using the UUID, you can find more information about that [here](/docs/flare/errors/searching-errors).
...
In Flare, we'll show that the exception was handled, it is possible to filter these exceptions. You'll find more about filtering exceptions [here](/docs/flare/errors/searching-errors).
