...
namespace Spatie\LaravelFlare\AttributesProviders\Concerns;
...
/**
 * @property ReduceArgumentPayloadAction $reduceArgumentPayloadAction
 * @property int $maxChainedJobReportingDepth
 */
trait ResolvesJobPayloadAttributes
{
