...
use Spatie\LaravelFlare\Solutions\SuggestCorrectVariableNameSolution;
use Throwable;
...
class UndefinedViewVariableSolutionProvider implements HasSolutionsForThrowable
{
    ...
    /**
     * @param \Spatie\LaravelFlare\Exceptions\ViewException $throwable
    ...
    protected function findCorrectVariableSolutions(
        ...
        return collect($throwable->getViewData())
            ...
            ->map(fn ($solution) => BaseSolution::create($solution->getSolutionTitle())
    ...
    protected function findOptionalVariableSolution(string $variableName, string $viewFile): Solution
    {
        ...
        return BaseSolution::create($optionalSolution->getSolutionTitle())
